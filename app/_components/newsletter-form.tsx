    ...
    <div className='relative flex items-center space-y-2'>
      ...
      >
        {state?.data ? (
          ...
          <>
            <p className='peer transition-transform translate-y-6 absolute group-focus-within:-translate-y-5 delay-100 duration-400 ease-in-out ml-1'>Sign up for updates, news, and free resources!</p>
